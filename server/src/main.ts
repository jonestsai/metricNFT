...
const getSales = async (beforeSignature:any) => {
  ...
  const publicKey = new PublicKey('9bv3v4DFoXSBCyCRepp8gQYUMdjfjZVeR9qyoPmhz6Uv'); // Reptilian Renegade (Lizards)
  // const publicKey = new PublicKey('MF6wYTno1WMneM2bGaSDdFBJm8dehB2sQ1Dq8PBmpbc'); // Trippin' Ape Tribe
  let result;
