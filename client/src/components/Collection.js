...
export default class Collection extends React.Component {
  ...
  render() {
    ...
    const { image, name, floorprice, _1dfloor, _7dfloor, _24hvolume, maxsupply, ownerscount, listedcount } = this.props.collection;
    ...
    return (
      <tr>
        ...
        <td className="text-white-50 text-end align-middle">{parseFloat(floorprice).toFixed(2)}</td>
        ...
        <td className="text-white-50 text-end align-middle">{(floorprice * maxsupply).toFixed(2)}</td>
